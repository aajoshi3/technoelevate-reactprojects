                      ...
                      <Col lg={3}>
                        ...
                        >
                          <Form.Select
                            ...
                            name="difficult"
                            value={values.diffiultyLevel}
                            onChange={(event) => handleLevelChange(i, event)}
                          >
                            <option> select...</option>
9                            <option value="1">easy</option>
                            <option value="2">Intermediate</option>
                            <option value="3">Expert</option>
                          </Form.Select>
                          {errors.diffiultyLevel && <p className='diffcolor'>{errors.diffiultyLevel}</p>}
       ...
       {questions.length - 1 === i && <button class="btn" onClick={handleAddClick}><i class="fa fa-plus-circle"></i> Add New</button>}
          ...
          <br />
          <Container>
            <button className="btn1" style={{ color: "white" }} onClick={handleSubmit}>
              {" "}
              Submit{" "}
            </button>
          </Container>
