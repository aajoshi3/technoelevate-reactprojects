...
// });
  ...
  const validateQuestion = (index) => {
    // let regex = /^[a-zA-Z]+$/;
  // let questionChange=  handleQuestionChange()
  ...
  const validateDifficultyLevel = (index) => {
    let difficultyLevel = questions.difficultyLevel;
    if (difficultyLevel) {
  ...
  const handleAddClick = () => {
    ...
    let isDifficultyLevelValid = validateDifficultyLevel();
    if (isQuestionValid) {
      setquestionError('')
      const questionsCopy = [...questions];
                  ...
                  <Container >
                    <Row>
                      <Col lg={9}>
                        ...
                        {/* {errors && <p className='color1'>please write a valid question</p>} */}
                        <small style={{color:'red'}} >{questions.qustion ? setquestionError(''):setquestionError('hi')}</small>
                      </Col>

                      <Col lg={3}>
                        <FloatingLabel
                          controlId="floatingSelect"
                          lab el="Difficulty level"
                          classinput="mb-3"
                        >
                          <Form.Select
                          ...
                          {/* <small>{questions.length === (i + 1) ? difficultyLevelError : ''}</small> */}
                    ...
                    <Row>
                      <Col lg={9}>
                        ...
                        >
                          ...
                          />
                            {/* {errors.answer && <p className='color2'>{errors.answer}</p>} */}
                        </FloatingLabel>
                        <br />
                        <br />
                      </Col>
