...
// });
  ...
  const validateDifficultyLevel = (index) => {
    let difficultyLevel = questions[index].difficultylevel;
    if (difficultyLevel) {
                  ...
                  <Container >
                    <Row>
                      <Col lg={9}>
                        ...
                        <small style={{color:'red'}} >{questions.length === (i + 1) ? errors :''}</small>
                      </Col>
                      ...
                      <Col lg={3}>
                        ...
                        >
                          ...
                          <small>{questions.length === (index + 1) ? difficultyLevelError : ''}</small>
